                            ...
                            <div class="tab-content">
                              <!-- 1ST TAB -->
                                <div class="tab-pane fade in mt-2" id="wheat">
                                  <div class="row">
                                    ...
                                    ?>
                              <!-- 2ND TAB -->
                                <div class="tab-pane fade in mt-2" id="kerosene">
                                  <div class="row">
                              ...
                              <!-- 3rd TAB -->
                                <div class="tab-pane fade in mt-2" id="sugar">
                                  <div class="row">
                              ...
                              <!-- 4th TAB -->
                                <div class="tab-pane fade in mt-2" id="rice">
                                  <div class="row">
                              ...
                              <!-- 5th TAB -->
                                <div class="tab-pane fade in mt-2" id="oil">
                                  <div class="row">
                              ...
                              <!-- 6th TAB -->
                                <div class="tab-pane fade in mt-2" id="salt">
                                  <div class="row">
                              ...
                              <!-- 7th TAB -->
                                <div class="tab-pane fade in mt-2" id="coffe/Tea powder">
                                  <div class="row">
