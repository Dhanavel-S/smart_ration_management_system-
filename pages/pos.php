                    ...
                    <h4 class="m-1 text-lg text-primary">Product category</h4>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#wheat" data-toggle="tab">Wheat</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#kerosene" data-toggle="tab">Kerosene</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#sugar" data-toggle="tab">Sugar</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#rice" data-toggle="tab">Rice</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#oil" data-toggle="tab">Oil</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#salt" data-toggle="tab">Salt</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#coffe/Tea Powder" data-toggle="tab">Coffe/Tea Powder</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#paruppu" data-toggle="tab">Paruppu</a>
                              </li>
                              <li class="nav-item">
